...
public class Topic implements Serializable {
	...
	private List<String> relatedSenses;

	/**
	 * Create a new Topic with the provided label. The score for this topic will be set to {@link Double#NaN}!
	 *
	 * @param label
	 *            Label of the topic
	 */
